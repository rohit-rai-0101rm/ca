                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                ...
                                <span className="subtitle">Mobile Programming’s eLearning solutions will help educational, research, and training institutes to reach out to students with customized information and facilitate enhanced learning experience in order to meet the ever-increasing requirements of high-quality education, in a cost-effective manner.</span>
