                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                ...
                                <span className="subtitle">Mobile Programming can help retail and e-commerce companies apply third-party technologies to transform decision making, automate processes, enabling exceptional customer experience.</span>
