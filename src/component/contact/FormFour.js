...
const FormFour = () => {
    ...
    return (
        ...
        <div className="form-group">
            <input placeholder="Company*" type="text" className="form-control" name="contact-email" required />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
            ...
            <select className="form-control" name="help">
            <option value="volvo">Designing</option>
