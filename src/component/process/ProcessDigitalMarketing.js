...
import ProcesstData from "../../data/process/ProcessDm.json";
import Tilty from 'react-tilty';
import SectionTitle5 from '../../elements/section-title/SectionTitle5';

const getProcesstData = ProcesstData;

const ProcessDigitalMarketing = () => {
    return (
        
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle5 
                title="How to Choose a Full-Service Digital Marketing Agency For your Project"
                textAlignment=""
                textColor="mb--90"
            />
...
export default ProcessDigitalMarketing;