...
const HireSeoExpert = () => {
  return (
    <div className="section section-padding bg-color-light pb--70">
      <center>
        <h3>
          Would you like to hire a professional SEO Expert who is both brilliant
          and culturally fit?
        </h3>
        <p className="innovate-list-para">
        50,000+ professionals have been screened for their technical skills, language proficiency, and behavioral aspects - so you get the best one for your company.
        </p>
      </center>
      <center>
        {" "}
