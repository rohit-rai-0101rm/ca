...
import ProcesstData from "../../data/process/ProcessShopify.json";
...
const StepsToHire = () => {
    return (
        ...
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                title="Would you like to hire a talented team player who is both brilliant and culturally fit?"
                description="50,000+ talents have been screened for their technical skills, language proficiency, and behavioral aspects - so you get the best one for your company."
