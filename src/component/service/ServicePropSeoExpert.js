...
import ServiceData from "../../data/service/ServiceSeoExperts.json";
import { slugify } from '../../utils';


const AllData = ServiceData;

const ServicePropSeoExpert= ({colSize, serviceStyle, itemShow, marginTop}) => {
...
export default ServicePropSeoExpert ;