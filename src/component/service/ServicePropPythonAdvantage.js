...
import ServiceData from "../../data/service/ServicePython.json";
import { slugify } from '../../utils';


const AllData = ServiceData;

const ServicePropPythonAdvantage= ({colSize, serviceStyle, itemShow, marginTop}) => {
...
export default ServicePropPythonAdvantage ;