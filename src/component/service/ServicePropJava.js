...
import ServiceJava from "../../data/service/ServiceJava.json";
import { slugify } from '../../utils';


const AllData = ServiceJava;

const ServicePropJava= ({colSize, serviceStyle, itemShow, marginTop}) => {
...
export default ServicePropJava ;