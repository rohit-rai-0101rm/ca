...
import ServiceData from "../../data/service/ServiceDotNetDevelopers.json";
import { slugify } from '../../utils';


const AllData = ServiceData;

const ServicePropDotNet = ({colSize, serviceStyle, itemShow, marginTop}) => {
...
export default ServicePropDotNet ;