    ...
    return (
        <div className="section section-padding">
            <div className="container">
               <h3 className='titleUnique'>hear what<strong className='uniqueBold'> brands</strong>  around the world <br/><strong className='uniqueBold'>saying</strong> about NXG.</h3>
                <div className="row">
