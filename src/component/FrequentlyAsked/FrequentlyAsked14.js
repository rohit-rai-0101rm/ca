                ...
                <div className="faq-accordion">
                    <Accordion defaultActiveKey="1">
                            <Accordion.Item>
                                ...
                                <Accordion.Body>
                                <p className='innovate-list-paraABC'>The full-time hiring of a Salesforce Consultant from us will cost you approximately $2000 a month. There are various factors that determine the hiring cost, including consultants' years of technical experience with Salesforce, Salesforce certifications they have, specific vertical industry experience, exposure to large projects, etc.
                                </p>
                                <br/>
                                 </Accordion.Body>
                            </Accordion.Item>
                    ...
                    <Accordion defaultActiveKey="2">
                            <Accordion.Item>
                                ...
                                <p className='innovate-list-paraABC'>You can hire Salesforce consultants from India on-demand who work as an extension to your in-house team.</p>
                                <br/>
                    ...
                    <Accordion defaultActiveKey="5">
                            <Accordion.Item>
                                ...
                                <p className='innovate-list-paraABC'><strong>Step 5: </strong>Technical evaluation</p>
                                <p className='innovate-list-paraABC'><strong>Step 6: </strong> Final Interview.</p>
                                </Accordion.Body>
                            </Accordion.Item>
                    </Accordion>
                    <br/>
