                ...
                <div className="row align-items-end align-items-xl-start">
                    <div className="col-lg-12">
                        <div className="banner-content">
                            ...
                            <center>
                                <h1 className="title">Hire Salesforce Consultants from India's Top Talent Network</h1>
                                <h3>Meet your Salesforce functional and technical needs with our certified Salesforce consultants.</h3>
                                <span className="subtitle">Finding it tough to design and implement easy to maintain and scalable Sales or Service Cloud solutions? Our pre-vetted Functional Consultants can help. Moreover, with solid technical knowledge of configuration and code, our Salesforce Technical Consultants possess a good experience in Sales Cloud, Service Cloud, Marketing Cloud, Community Cloud, Einstein, and Pardot.</span>
